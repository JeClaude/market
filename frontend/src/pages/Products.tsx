      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div>
            ...
            {/* Add to Cart */}
            <button className="w-full bg-orange-400 hover:bg-orange-500 text-white py-3 rounded-lg text-sm font-semibold transition-colors flex items-center justify-center gap-2 mb-3">
              🛒 Add to Cart
            </button>
